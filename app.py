...
<head>
    ...
    <title>AdaBoost Customer Predictor</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Customer Predictive Portal</h1>
            <p>Input customer characteristics below to obtain predictions</p>
        </div>

        <form id="predictionForm" class="form-grid">
            <div class="form-group">
                <label for="age">Age</label>
                <input type="number" id="age" name="Age" placeholder="e.g. 35" required min="18" max="100">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="delay" name="Payment Delay" placeholder="e.g. 3" required min="0">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="interaction" name="Last Interaction" placeholder="e.g. 7" required min="0">
            </div>
        ...
        document.getElementById('predictionForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    resultBox.innerText = `Prediction Output Class: ${res.prediction}`;
                } else {
                    resultBox.className = 'result-box error';
                    resultBox.innerText = res.error || 'An error occurred during estimation.';
                }
            } catch (err) {
                resultBox.className = 'result-box error';
...
# Text mapping dictionary for categorical variables
CATEGORICAL_MAPS = {
...
def predict():
    ...
    try:
        ...
        # Explicit feature ordering required by the AdaBoost model
        feature_order = [
        ...
        for feature in feature_order:
            ...
            # Convert categorical selections to respective numeric values
            if feature in CATEGORICAL_MAPS and val in CATEGORICAL_MAPS[feature]:
                val = CATEGORICAL_MAPS[feature][val]
            else:
                val = float(val)
